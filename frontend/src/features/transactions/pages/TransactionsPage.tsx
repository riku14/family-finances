                ...
                <CardContent className="p-0">
                    ...
                    <div className="grid grid-cols-3 divide-x divide-border">
                        ...
                        <div className="px-4 py-3 text-center">
                            ...
                            <p className={`font-bold ${summary.balance >= 0 ? "text-green-600" : "text-red-500"}`}>
                        ...
                        return (
                            <Card key={date} className="overflow-hidden py-0 gap-0">
                                ...
                                <div className="flex items-center justify-between px-4 py-2.5 bg-muted/40 border-b">
                                    ...
                                    <span className={`text-sm font-semibold ${net >= 0 ? "text-green-600" : "text-red-500"}`}>
                                            ...
                                            <div className="flex items-center gap-3 px-4 py-3">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <p className="text-xs text-muted-foreground truncate">
                                                        {formatDateShort(date)}{t.memo ? ` · ${t.memo}` : ""}
                                                    </p>
                                                </div>
                                                {/* 金額 */}
                                                <span className={`font-semibold text-sm whitespace-nowrap ${t.type === "INCOME" ? "text-green-600" : "text-red-500"}`}>
                                                    {t.type === "INCOME" ? "+" : "−"}¥{(t.amount ?? 0).toLocaleString()}
                                                </span>
                                                {/* 編集・削除 */}
                                                <div className="flex items-center gap-1 shrink-0">
                                                    <Button variant="ghost" size="icon" className="h-7 w-7 text-muted-foreground" onClick={() => openEdit(t)}>
                                                    ...
                                                    <AlertDialog>
                                                        ...
                                                        <AlertDialogContent>
                                                            <AlertDialogHeader>
                                                                ...
                                                                <AlertDialogDescription>この取引を削除します。この操作は取り消せません。</AlertDialogDescription>
                                                            </AlertDialogHeader>
                                                            <AlertDialogFooter>
                                                                <AlertDialogCancel>キャンセル</AlertDialogCancel>
                                                                <AlertDialogAction onClick={() => handleDelete(t.id!)} className="bg-destructive hover:bg-destructive/90">削除</AlertDialogAction>
                                                            </AlertDialogFooter>
                                                        </AlertDialogContent>
                                                    </AlertDialog>
                                                </div>
                            ...
                            <AlertDialog>
                                ...
                                <AlertDialogContent>
                                    ...
                                    <AlertDialogFooter>
                                        <AlertDialogCancel>キャンセル</AlertDialogCancel>
                                        <AlertDialogAction
                                            onClick={async () => { await handleDelete(editing.id!); setDialogOpen(false) }}
