      ...
      <div className="rounded-lg border p-6 space-y-4  bg-card shadow-lg">
        ...
        <div className="flex justify-between text-sm">
          ...
          <div>
            ...
            <p
              className={`font-semibold ${summary.balance >= 0 ? "text-green-600" : "text-destructive"}`}
            >
              ...
              {transactions.slice(0, 5).map((t, i) => (
                <>
                  ...
                  <li key={t.id} className="flex items-start justify-between py-3 gap-3">
                    ...
                    <span
                      className={`font-semibold whitespace-nowrap ${t.type === "INCOME" ? "text-green-600" : "text-red-500"}`}
                    >
